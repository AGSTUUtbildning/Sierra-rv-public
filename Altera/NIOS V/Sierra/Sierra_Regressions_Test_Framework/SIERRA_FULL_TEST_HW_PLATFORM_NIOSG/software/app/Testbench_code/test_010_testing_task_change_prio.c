...
static void task_1_code(void)
{
    ...
    */
    sierra_change_task_prio(task_3, 6);
    sierra_change_task_prio(task_2, 5);
    sierra_change_task_prio(task_6, 4);
    sierra_change_task_prio(task_5, 3);
    sierra_change_task_prio(task_4, 2);
    sierra_change_task_prio(task_7, 1);
