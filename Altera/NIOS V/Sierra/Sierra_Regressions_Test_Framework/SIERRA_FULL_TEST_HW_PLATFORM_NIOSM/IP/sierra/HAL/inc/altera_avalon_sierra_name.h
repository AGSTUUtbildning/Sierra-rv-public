/*!
 * \file       altera_avalon_sierra_name.h
 * \details    HW-specific RTOS IRQ and BASE defines
...
#ifndef __ALTERA_AVALON_SIERRA_NAME_H__
#define __ALTERA_AVALON_SIERRA_NAME_H__
...
#endif /* __ALTERA_AVALON_SIERRA_NAME_H__ */
